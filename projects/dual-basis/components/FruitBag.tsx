...
export function FruitBag({ apples, bananas, tone }: { apples: Quantity; bananas: Quantity; tone?: "apple" | "banana" }) {
  return <div className="fruit-bag" data-tone={tone} aria-label={`水果袋：${apples} 斤苹果，${bananas} 斤香蕉`}>
